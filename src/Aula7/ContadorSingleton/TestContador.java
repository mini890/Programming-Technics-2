...
public class TestContador {
	...
	public static void main(String[] args) {
		Contador ct1 = Contador.factory(3);// new Contador(3);
		Contador ct2;
		ct2 = Contador.factory(0);// new Contador();
		int c1 = ct1.getConta();
		ct1.setConta(5);
		c1 = ct1.getConta();
		ct1.setConta(10);
		...
		Contador ct3 = Contador.factory(5);
		...
		// Força a inicialização do Garbage Collector
		System.gc();
		// Força a execução de todos os destrutores (complementa System.gc)
